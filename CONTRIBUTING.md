...
Prefer deterministic controller logic in `custom_components/hydronicus/core/` and Home Assistant adapters at the integration boundary.
...
Use the repository-local `hydronicus-verify` skill to map milestone acceptance criteria to test and staging evidence.
